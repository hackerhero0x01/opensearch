...
public class DefaultUserInfoLabelingRule implements Rule{
    ...
    private final String REMOTE_ADDRESS = "remote_address";
    private final String USER_NAME = "user_name";
    private final String USER_BACKEND_ROLES = "user_backend_roles";
    private final String USER_ROLES = "user_roles";
    private final String USER_TENANT = "user_tenant";
    ...
    public Map<String, Object> evaluate(ThreadContext threadContext, SearchRequest searchRequest) {
        // for POC testing only. This is injected by the security plugin
        threadContext.putTransient(REQUEST_HEADER_USER_INFO, "chenyang|br1,b2|r1,r2|t1");
        threadContext.putTransient(REQUEST_HEADER_REMOTE_ADDRESS, "1.2.3.4");
